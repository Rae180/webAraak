...
import '../../../Dashboard/view/Screens/settings_screen.dart';
import '../../../Reports/view/Screens/UserReportsScreen.dart';
import '../../../SubGallery/view/Screens/SubGalleryManagementScreen.dart';
import '../../../SubGallery/view/Screens/add_branch_details_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static List<Widget> _screens = [
    ...
    const SubGalleryManagementScreen(),
     UsersListScreen(),
    ReportsScreen(),
    UserReportsScreen(),
    SettingsScreen(),
    AddBranchDetailsScreen(selectedManager: '',),
